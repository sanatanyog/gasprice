...
def main():
    # Configure app layout for mobile-friendliness
    ...
    # Display key metrics in a single line using columns
    ...
    # Country input with searchable dropdown, in main page
    ...
    if country_input and country_input != "":
        ...
        try:
            ...
            if show_plot:
                ...
                fig, ax = plt.subplots(figsize=(6, 4))  # Smaller figure for mobile
                ...
                ax.set_title(f"Global Price Distribution ({date})", fontsize=14, color='#0072B5')
